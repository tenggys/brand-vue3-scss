<script setup>
import { ref } from 'vue'
import BasketComp from './BasketComp.vue'
  ...
  <header class="header">
    <div class="container header__flex">
      ...
      <nav class="header__nav">
        <svg class="header__icon header__burger"  @click="toggleMenu" width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="header__basket" @click="toggleBasket">
            ...
            <span class="header__basket-icon" v-if="basketStore.totalItems > 0">{{ basketStore.totalItems }}</span>
            <BasketComp :class="{ 'basket--open': isBasketOpen }" :isBasketOpen="isBasketOpen"/>
        </div>
        <BasketComp />
      </nav>
    </div>
...
<style lang="scss">
  ...
  .header {
    ...
    &__basket-icon {
      ...
      background: $bgPinc;
      border-radius: 10px;
      @include text(400, 12px, 100%, $textWhite);
    }
